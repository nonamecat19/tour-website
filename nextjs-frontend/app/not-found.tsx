    ...
    <div className="grid min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-white lg:grid-cols-[max(50%,36rem),1fr]">
      ...
      <main
        ...
        <div className="max-w-lg">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Сторінка не знайдена</h1>
          <p className="mt-6 text-base leading-7 text-gray-600">
            Ви опинились там де не повинні(
          </p>
          <div className="mt-10">
            <Link href="/" className="text-sm font-semibold leading-7 text-indigo-600">
              <span aria-hidden="true">&larr;</span> Повернутись на головну
            </Link>
          </div>
        </div>
      </main>
